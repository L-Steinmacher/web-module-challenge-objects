...
function createMenuItem(name, price, category){
    let menuItems = {name, price, category};
    return menuItems;
}
...
*/
console.log(createMenuItem('taco', 1.5, 'amazing'));
console.log(createMenuItem('mulita', 2, 'amazing'));
console.log(createMenuItem('caldo', 5, 'wtf'));
...
*/
const newReview = {name: "lucas", rating: 5, feedback:"I'm a little teapot"};
...
reviews[7].feedback ="Absolutely love that they have karaoke Fridays! Food and drink selection is okay.";
console.log(reviews);
...
*/
 ...
 function getReviewByRating(arr,num) {
   ...
   for(let i = 0; i< arr.length; i++){
     if(arr[i].rating >= num && arr[i].rating < num + 0.9){
      scope.push(arr[i]);
     }
   }
    return scope;
